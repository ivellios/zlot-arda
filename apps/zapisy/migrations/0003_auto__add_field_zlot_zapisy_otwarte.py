...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Zlot.zapisy_otwarte'
        db.add_column('zapisy_zlot', 'zapisy_otwarte', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Zlot.zapisy_otwarte'
        db.delete_column('zapisy_zlot', 'zapisy_otwarte')
