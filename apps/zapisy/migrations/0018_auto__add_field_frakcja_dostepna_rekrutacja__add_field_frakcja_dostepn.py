...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Frakcja.dostepna_rekrutacja'
        db.add_column('zapisy_frakcja', 'dostepna_rekrutacja', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Frakcja.dostepny_opis'
        db.add_column('zapisy_frakcja', 'dostepny_opis', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Frakcja.dostepna_rekrutacja'
        db.delete_column('zapisy_frakcja', 'dostepna_rekrutacja')

        # Deleting field 'Frakcja.dostepny_opis'
        db.delete_column('zapisy_frakcja', 'dostepny_opis')
