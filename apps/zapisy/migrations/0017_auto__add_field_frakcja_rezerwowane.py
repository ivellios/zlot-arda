...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Frakcja.rezerwowane'
        db.add_column('zapisy_frakcja', 'rezerwowane', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Frakcja.rezerwowane'
        db.delete_column('zapisy_frakcja', 'rezerwowane')
