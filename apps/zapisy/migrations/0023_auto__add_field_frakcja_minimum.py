...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Frakcja.minimum'
        db.add_column('zapisy_frakcja', 'minimum', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Frakcja.minimum'
        db.delete_column('zapisy_frakcja', 'minimum')
