...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Frakcja.slug'
        db.add_column('zapisy_frakcja', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Frakcja.slug'
        db.delete_column('zapisy_frakcja', 'slug')
