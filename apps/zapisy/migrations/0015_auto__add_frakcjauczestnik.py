...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FrakcjaUczestnik'
        db.create_table('zapisy_frakcjauczestnik', (
            ('uczestnik', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zapisy.Uczestnik'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('frakcja', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zapisy.Frakcja'])),
        ))
        db.send_create_signal('zapisy', ['FrakcjaUczestnik'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'FrakcjaUczestnik'
        db.delete_table('zapisy_frakcjauczestnik')
