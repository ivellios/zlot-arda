...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Uczestnictwo.plemie'
        db.delete_column('zapisy_uczestnictwo', 'plemie_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Uczestnictwo.plemie'
        db.add_column('zapisy_uczestnictwo', 'plemie', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['zapisy.Plemie'], blank=True), keep_default=False)
