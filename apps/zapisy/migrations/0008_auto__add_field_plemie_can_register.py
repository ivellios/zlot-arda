...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plemie.can_register'
        db.add_column('zapisy_plemie', 'can_register', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Plemie.can_register'
        db.delete_column('zapisy_plemie', 'can_register')
