...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Uczestnictwo.timestamp'
        db.add_column('zapisy_uczestnictwo', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default='2012-05-01', auto_now_add=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Uczestnictwo.timestamp'
        db.delete_column('zapisy_uczestnictwo', 'timestamp')
    ...
    models = {
        ...
        'zapisy.zlot': {
            ...
            'plemiona': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['zapisy.Plemie']"}),
