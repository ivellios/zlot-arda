...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FrakcjaUczestnik.rezewowany'
        db.delete_column('zapisy_frakcjauczestnik', 'rezewowany')

        # Adding field 'FrakcjaUczestnik.rezerwowany'
        db.add_column('zapisy_frakcjauczestnik', 'rezerwowany', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'FrakcjaUczestnik.rezewowany'
        db.add_column('zapisy_frakcjauczestnik', 'rezewowany', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'FrakcjaUczestnik.rezerwowany'
        db.delete_column('zapisy_frakcjauczestnik', 'rezerwowany')
