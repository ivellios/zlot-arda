...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Frakcja.image'
        db.add_column('zapisy_frakcja', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Frakcja.image'
        db.delete_column('zapisy_frakcja', 'image')
