...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Frakcja.mozna_wybrac'
        db.add_column('zapisy_frakcja', 'mozna_wybrac', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Frakcja.limit'
        db.add_column('zapisy_frakcja', 'limit', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Frakcja.mozna_wybrac'
        db.delete_column('zapisy_frakcja', 'mozna_wybrac')

        # Deleting field 'Frakcja.limit'
        db.delete_column('zapisy_frakcja', 'limit')
