...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Frakcja.zasady_rekrutacji'
        db.add_column('zapisy_frakcja', 'zasady_rekrutacji', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Frakcja.zasady_rekrutacji'
        db.delete_column('zapisy_frakcja', 'zasady_rekrutacji')
